	...
	<div class="box viewport-tracking" data-viewport="Letzte_Formation">
		...
		<div class="formation_begegnung">
			...
			<div class="formation_ergebnis">
				<a title="Crónica" class="ergebnis-link" id="3773020">5:0</a>
			</div>
			<div class="formation_verein text-left">
				<a title="Sudáfrica"><img
		...
		<div class="large-7 columns small-12 aufstellung-vereinsseite"
			...
			<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							...
							title="Sustitución Min 65 por V.Lindelöf" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a>Kessié</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 65 por Laimer" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 79 Tonali" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 88 por Çalhanoglu" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 64 por  Ødegaard" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 2%; left: 50%;">
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 65 por Salah" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 2%; left: 30%;">
		...
		<div
			...
			<table class="ersatzbank">
				...
				<tr>
					...
					<td><a title="Victor Lindelöf">Victor Lindelöf</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 80 por Alaba" rel="tooltip">&nbsp;</span></td>
					<td>DFC</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
				...
				<tr>
					...
					<td><a title="Sandro Tonali">Sandro Tonali</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 79 por Barella" rel="tooltip">&nbsp;</span>
						<span style="cursor: pointer !important;"
				...
				<tr>
					...
					<td><a title="Konrad Laimer">Konrad Laimer</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 65 por Kessié" rel="tooltip">&nbsp;</span>
					</td>
					<td>MCD</td>
				</tr>
				<tr>
					...
					<td><a title="Hakan Çalhanoglu">Hakan Çalhanoglu</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 88 por Cuadrado" rel="tooltip">&nbsp;</span>
					</td>
					<td>MCO</td>
				</tr>
				<tr>
					...
					<td><a title="Martin  Ødegaard">Martin Ødegaard</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 64 por Mahrez" rel="tooltip">&nbsp;</span>
					</td>
					<td>MCO</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><a title="Mohammed Salah">Mohammed Salah</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 65 por Aubameyang" rel="tooltip">&nbsp;</span>
						<span style="cursor: pointer !important;"
