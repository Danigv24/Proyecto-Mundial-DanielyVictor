...
<%@ page import="com.model.Selecciones"%>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
         ...
         <ul class="navbar-nav me-auto mb-2 mb-md-0">
           ...
           <li class="nav-item dropdown ">
             ...
             <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
               ...
               <li><a class="dropdown-item text-dark" href="Arabia_Saudita.jsp">Arabia Saudita</a></li>
               ...
               <li><a class="dropdown-item text-dark" href="Corea.jsp">Corea del Sur</a></li>
               ...
               <li><a class="dropdown-item text-dark" href="EstadosUnidos.jsp">Estados Unidos</a></li>
               ...
               <li><a class="dropdown-item text-dark" href="Paisesbajos.jsp">Países Bajos</a></li>
  ...
  <form  action="ServletForm" method="POST">
    ...
    <input type="text" class="form-control" name="nombre" pattern="[a-zA-ZáéíóúAÉÍÓÚÑñ\s]{3,20}" required>
  </div>
  <div class="input-group mb-3">
    <span class="input-group-text" id="inputGroup-sizing-default" name="posicion">Posición del Jugador</span>
	<input type="text"class="form-control"  name="posicion" pattern="[A-Z]{1,3}" required>
  </div>
  <div class="input-group mb-3">
    <span class="input-group-text" id="inputGroup-sizing-default" name="dorsal">Dorsal del Jugador</span>
	<input type="text"class="form-control"  name="dorsal" pattern="[0-9]{1,2}" required>
  </div>
  <div class="input-group mb-3">
     <span class="input-group-text" id="inputGroup-sizing-default" name="dorsal">País del Jugador</span>
	<input type="text"class="form-control"  name="nombreequipo" pattern="[0-9]{1,2}" required>
    </div>
    

      <button name="enviar" type="submit" >Insertar</button>

  </form>

<h1>Listado de Seleccion</h1>
		...
		<table class="alee">
			...
			<tbody>
				<%
					LinkedList<Selecciones> lista2 = Controller.getSeleccion();
					for (int i = 0; i < lista2.size(); i++) {
					out.println("<tr class='alee'>");
					out.println("<td>" + lista2.get(i).getId() + "</td>");
