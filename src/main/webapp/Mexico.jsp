...
<link rel="stylesheet" type="text/css" href="mexico.css" />
...
<title>Selección Méxicana de Fútbol</title>
</head>
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown "><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item text-danger" href="#">México</a></li>
							<li><a class="dropdown-item text-dark"
	...
	<br>
	<h1>
		Selección Méxicana de Fútbol <img src="imagenes/mexico.png"
			alt="mexico" width="100" height="100">
	</h1>
	...
	<table class="alee">
		...
		<tbody>
			<%
					LinkedList<Jugadores> lista2 = Controller.getMexico();
	...
	<div class="keys" style="display: none"
		title="/mexiko/startseite/verein/6303">
		<span>356042</span><span>71401</span><span>29559</span><span>50965</span><span>387687</span><span>312568</span><span>64134</span><span>532937</span><span>687558</span><span>51046</span><span>295373</span><span>469718</span><span>344854</span><span>356044</span><span>513970</span><span>401356</span><span>534620</span><span>532938</span><span>298796</span><span>122043</span><span>424689</span><span>316889</span><span>125165</span><span>353583</span><span>355998</span><span>371174</span><span>206040</span><span>552955</span><span>286339</span>
	</div>
	</div>
	</div>
	...
	<div class="box viewport-tracking" data-viewport="Letzte_Formation">
		...
		<div class="formation_begegnung">
			<div class="formation_verein text-right">
				<a title="México"/mexiko/startseite/verein/6303/saison_id/2020">México</a>
				<a title="México"/mexiko/startseite/verein/6303/saison_id/2020"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/110.png?lm=1520611569"
					title="México" alt="México" class="flaggenrahmen" /></a>
			</div>
			<div class="formation_ergebnis">
				<a title="Crónica" class="ergebnis-link" id="3583617"/spielbericht/index/spielbericht/3583617">2:0</a>
			</div>
			<div class="formation_verein text-left">
				<a title="El Salvador"/el-salvador/startseite/verein/13951/saison_id/2020"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/45.png?lm=1520611569"
					title="El Salvador" alt="El Salvador" class="flaggenrahmen" /></a> <a
					title="El Salvador"/el-salvador/startseite/verein/13951/saison_id/2020">El
					Salvador</a>
			</div>
			<div class="clearer"></div>
		</div>
			...
			<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/guillermo-ochoa/profil/spieler/29559">Ochoa</a>
						</span>
					</div>
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/nestor-araujo/profil/spieler/64134">Araújo</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/cesar-montes/profil/spieler/387687">Montes</a>
						</span>
					</div>
					<div
						...
						<span style="cursor: pointer !important;"
							...
							title=" Sustitución Min 79 por H.Moreno" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/jesus-gallardo/profil/spieler/344854">Gallardo</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/jorge-sanchez/profil/spieler/356044">Sánchez</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/edson-alvarez/profil/spieler/401356">Álvarez</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/erick-gutierrez/profil/spieler/298796">Gutiérrez</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; left: 36%; bottom: 73%;">
						<span class="icons_sprite icon-gelbekarte-formation" span
							title=" Tarjeta Amarilla Min 90+1" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/carlos-rodriguez/profil/spieler/534620">Rodríguez</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title=" Sustitución Min 73 por L.Romo" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/alexis-vega/profil/spieler/424689">Vega</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title=" Sustitución Min 73 por J.Corona" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/uriel-antuna/profil/spieler/355998">Antuna</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; right: 32%;">
						<span class="icons_sprite icon-tor-formation" span
							title=" GOL Min 17" rel="tooltip">&nbsp;</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title=" Sustitución Min 64 H.Lozano" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 3%; left: 40%;">
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/raul-jimenez/profil/spieler/206040">Jiménez</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; right: 32%;">
						<span class="icons_sprite icon-tor-formation" span
							title=" GOL Min 43" rel="tooltip">&nbsp;</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title=" Sustitución Min 63 por H.Martin" rel="tooltip">&nbsp;</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div
			...
			<table class="ersatzbank">
				<tr>
					...
					<td><a title="Rodolfo Cota"/rodolfo-cota/profil/spieler/71401">Rodolfo
							Cota</a></td>
					<td>POR</td>
				</tr>
				<tr>
					...
					<td><a title="Alfredo Talavera"/alfredo-talavera/profil/spieler/50965">Alfredo
							Talavera</a></td>
					<td>POR</td>
				</tr>
				<tr>
					...
					<td><a title="Héctor Moreno"/hector-moreno/profil/spieler/51046">Héctor
							Moreno</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title=" Sustitución Min 79 por C.Montes" rel="tooltip">&nbsp;</span>
					</td>
					<td>CEN</td>
				</tr>
				<tr>
					...
					<td><a title="Johan Vásquez"/johan-vasquez/profil/spieler/532937">Johan
							Vásquez</a></td>
					<td>CEN</td>
				</tr>
				<tr>
					...
					<td><a title="Érick Aguirre"/erick-aguirre/profil/spieler/295373">Érick
							Aguirre</a></td>
					<td>LI</td>
				</tr>
				<tr>
					...
					<td><a title="Gerardo Arteaga"/gerardo-arteaga/profil/spieler/469718">Gerardo
							Arteaga</a></td>
					<td>LI</td>
				</tr>
				<tr>
					...
					<td><a title="Luis Romo"/luis-romo/profil/spieler/532938">Luis
							Romo</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title=" Sustitución Min 73 C.Rodriguez" rel="tooltip">&nbsp;</span>
					</td>
					<td>MC</td>
				</tr>
				<tr>
					...
					<td><a title="Diego Lainez"/diego-lainez/profil/spieler/371174">Diego
							Lainez</a></td>
					<td>ED</td>
				</tr>
				<tr>
					...
					<td><a title="Hirving Lozano"/hirving-lozano/profil/spieler/316889">Hirving
							Lozano</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title=" Sustitución Min 64 pot U.Antuna " rel="tooltip">&nbsp;</span>
					</td>
					<td>ED</td>
				</tr>
				<tr>
					...
					<td><a title="Tecatito Corona"/tecatito-corona/profil/spieler/125165">Tecatito
							Corona</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title=" Sustitución Min 73 por A.Vega" rel="tooltip">&nbsp;</span>
					</td>
					<td>ED</td>
				</tr>
				<tr>
					...
					<td><a title="Santiago Giménez"/santiago-gimenez/profil/spieler/552955">Santiago
							Giménez</a></td>
					<td>DEL</td>
				</tr>
				<tr>
					...
					<td><a title="Henry Martín"/henry-martin/profil/spieler/286339">Henry
							Martín</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title=" Sustitución Min 63 por Raúl Jiménez" rel="tooltip">&nbsp;</span>
					</td>
					<td>DEL</td>
				</tr>
				<tr style="background-color: #FBFBFB;">
					...
					<td><a title="Tata Martino" id="0"/tata-martino/profil/trainer/5616">Tata
							Martino</a></td>
					<td>&nbsp;</td>
				</tr>
			</table>
