...
<link rel="stylesheet" type="text/css" href="Marruecos.css" />
...
<title>Selección de Fútbol Marroquí</title>
</head>
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown "><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item text-danger" href="#">Marruecos</a></li>
	...
	<br>
	<h1>
		Selección de Fútbol Marroquí <img src="imagenes/marruecos.png"
			alt="marruecos" width="100" height="100">
	</h1>
	...
	<table class="alee">
		...
		<tbody>
			<%
					LinkedList<Jugadores> lista2 = Controller.getMarruecos();
	...
	<div class="keys" style="display: none"
		title="/marokko/startseite/verein/3575">
		<span>207834</span><span>97925</span><span>238997</span><span>544414</span><span>361914</span><span>204198</span><span>331840</span><span>235412</span><span>236956</span><span>286949</span><span>366746</span><span>398073</span><span>434358</span><span>287579</span><span>255749</span><span>635336</span><span>593482</span><span>174344</span><span>377219</span><span>380473</span><span>724520</span><span>245228</span><span>232271</span><span>433049</span><span>223725</span><span>521127</span><span>249543</span>
	</div>
	</div>
	</div>
	...
	<div class="box viewport-tracking" data-viewport="Letzte_Formation">
		...
		<div class="formation_begegnung">
			<div class="formation_verein text-right">
				<a title="Marruecos"/marokko/startseite/verein/3575/saison_id/2019">Marruecos</a>
				<a title="Marruecos"/marokko/startseite/verein/3575/saison_id/2019"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/107.png?lm=1520611569"
					title="Marruecos" alt="Marruecos" class="flaggenrahmen" /></a>
			</div>
			<div class="formation_ergebnis">
				<a title="Crónica" class="ergebnis-link" id="3736289"/spielbericht/index/spielbericht/3736289">4:1</a>
			</div>
			<div class="formation_verein text-left">
				<a title="República Democrática del Congo"/demokratische-republik-kongo/startseite/verein/3854/saison_id/2019"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/193.png?lm=1520611569"
					title="República Democrática del Congo"
					alt="República Democrática del Congo" class="flaggenrahmen" /></a> <a
					title="República Democrática del Congo"/demokratische-republik-kongo/startseite/verein/3854/saison_id/2019">RD
					Congo</a>
			</div>
			<div class="clearer"></div>
		</div>
			...
			<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/bono/profil/spieler/207834">Bono</a>
						</span>
					</div>
					<div
						...
						<span style="cursor: pointer !important;"
							...
							title="Sustitución Min 43 por Munir" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 61%; left: 56.5%;">
					<div class=" aufstellung-rueckennummer-box">
						<div class="rn">5</div>
					</div>
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/nayef-aguerd/profil/spieler/361914">Aguerd</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/romain-saiss/profil/spieler/204198">Saïss</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 61%; left: 23.5%;">
					<div class=" aufstellung-rueckennummer-box">
						<div class="rn">18</div>
					</div>
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/jawad-el-yamiq/profil/spieler/235412">El
								Yamiq</a>
						</span>
					</div>
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 8 por Mmaee S" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 59%; left: 7%;">
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/adam-masina/profil/spieler/286949">Masina</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 81 por Attiat-Allal" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/achraf-hakimi/profil/spieler/398073">Hakimi</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; right: 32%;">
						<span class="icons_sprite icon-tor-formation" span
							title="GOL Min 69" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/sofyan-amrabat/profil/spieler/287579">Amrabat</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; left: 36%; bottom: 73%;">
						<span class="icons_sprite icon-gelbekarte-formation" span
							title="Tarjeta Amarilla Min 25" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/azzedine-ounahi/profil/spieler/593482">Ounahi</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; right: 32%;">
						<span class="icons_sprite icon-tor-formation" span
							title="GOL Min 21" rel="tooltip">&nbsp;</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; right: 22%;">
						<span class="icons_sprite icon-tor-formation" span
							title="GOL Min 54" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/selim-amallah/profil/spieler/377219">Amallah</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; left: 36%; bottom: 73%;">
						<span class="icons_sprite icon-gelbekarte-formation" span
							title="Tarjeta Amarilla Min 90+4" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 2%; left: 30%;">
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/tarik-tissoudali/profil/spieler/245228">Tissoudali</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; right: 32%;">
						<span class="icons_sprite icon-tor-formation" span
							title="GOL Min 45+7" rel="tooltip">&nbsp;</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 80 por Boufal" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 2%; left: 50%;">
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/ayoub-el-kaabi/profil/spieler/521127">El
								Kaabi</a>
						</span>
					</div>
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 81 por Ryan Mmaee" rel="tooltip">&nbsp;</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div
			...
			<table class="ersatzbank">
				<tr>
					...
					<td><a title="Ahmed Reda Tagnaouti"/ahmed-reda-tagnaouti/profil/spieler/238997">Ahmed
							Reda Tagnaouti</a></td>
					<td>POR</td>
				</tr>
				<tr>
					...
					<td><a title="Munir"/munir/profil/spieler/97925">Munir</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 43 por Bono" rel="tooltip">&nbsp;</span></td>
					<td>POR</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Samy Mmaee"/samy-mmaee/profil/spieler/331840">Samy
							Mmaee</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 8 por El Yamiq" rel="tooltip">&nbsp;</span>
					</td>
					<td>CEN</td>
				</tr>
				<tr>
					...
					<td><a title="Yahia Attiyat Allah"/yahia-attiyat-allah/profil/spieler/366746">Yahia
							Attiyat Allah</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 81 por Masina" rel="tooltip">&nbsp;</span>
					</td>
					<td>LI</td>
				</tr>
				<tr>
					...
					<td><a title="Sofiane Alakouch"/sofiane-alakouch/profil/spieler/434358">Sofiane
							Alakouch</a></td>
					<td>LD</td>
				</tr>
				<tr>
					...
					<td><a title="Fayçal Fajr"/faycal-fajr/profil/spieler/174344">Fayçal
							Fajr</a></td>
					<td>MC</td>
				</tr>
				<tr>
					...
					<td><a title="Imrân Louza"/imran-louza/profil/spieler/635336">Imrân
							Louza</a></td>
					<td>MC</td>
				</tr>
				<tr>
					...
					<td><a title="Ilias Chair"/ilias-chair/profil/spieler/380473">Ilias
							Chair</a></td>
					<td>MCO</td>
				</tr>
				<tr>
					...
					<td><a title="Sofiane Boufal"/sofiane-boufal/profil/spieler/232271">Sofiane
							Boufal</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 80 por Tissoudali" rel="tooltip">&nbsp;</span>
						<span style="cursor: pointer !important;"
						class="icons_sprite icon-gelbekarte-formation" span
						title="Tarjeta Amarilla Min 90+3" rel="tooltip">&nbsp;</span></td>
					<td>EI</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Munir El Haddadi"/munir-el-haddadi/profil/spieler/223725">Munir
							El Haddadi</a></td>
					<td>DEL</td>
				</tr>
				<tr>
					...
					<td><a title="Youssef En-Nesyri"/youssef-en-nesyri/profil/spieler/433049">Youssef
							En-Nesyri</a></td>
					<td>DEL</td>
				</tr>
				<tr>
					...
					<td><a title="Ryan Mmaee"/ryan-mmaee/profil/spieler/249543">Ryan
							Mmaee</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 81 por El Kaabi" rel="tooltip">&nbsp;</span>
					</td>
					<td>DEL</td>
				</tr>
				<tr style="background-color: #FBFBFB;">
					...
					<td><a title="Vahid Halilhodzic" id="0"/vahid-halilhodzic/profil/trainer/1231">Vahid
							Halilhodzic</a></td>
					<td>&nbsp;</td>
				</tr>
			</table>
