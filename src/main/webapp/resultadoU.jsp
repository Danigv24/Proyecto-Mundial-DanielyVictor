...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="jugadora.css" type="text/css"
	media="screen" />
<script
...
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-md-0">
					...
					<li class="nav-item dropdown "><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item text-dark" href="DaniTeam.jsp">Dani
									FC</a></li>
	...
	<div class="container">
		...
		<img src="imagenes/alfo.gif" alt="alfo"> <br>
		<h1>Pulsa para Iniciar Sesión</h1>
		<form action="iniciarsesion.html">
			<div class="input-group mb-3"></div>
			<button type="submit">IniciarSesión</button>
		</form>
	</div>
</body>
</html>
