...
<title>Selección de Fútbol de Serbia</title>
</head>
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown "><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item text-danger" href="#">Serbia</a></li>
	...
	<br>
	<h1>
		Selección de Fútbol de Serbia <img src="imagenes/serbia.png"
			alt="serbia" width="100" height="100">
	</h1>
	...
	<table class="alee">
		...
		<tbody>
			<%
					LinkedList<Jugadores> lista2 = Controller.getSerbia();
	...
	<div class="keys" style="display: none"
		title="/serbien/startseite/verein/3438">
		<span>190263</span><span>94308</span><span>257474</span><span>413507</span><span>574671</span><span>202228</span><span>160222</span><span>143559</span><span>143029</span><span>404260</span><span>168063</span><span>222813</span><span>417575</span><span>74294</span><span>266302</span><span>245056</span><span>161011</span><span>271455</span><span>36139</span><span>245078</span><span>206843</span><span>357498</span><span>51152</span><span>257462</span>
	</div>
	</div>
	</div>
			...
			<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/predrag-rajkovic/profil/spieler/190263">Rajkovic</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/strahinja-pavlovic/profil/spieler/574671">Pavlovic</a>
						</span>
					</div>
					<div
						...
						<span style="cursor: pointer !important;"
							...
							title="Sustitución Min 73 por S.Mitrovic" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/milos-veljkovic/profil/spieler/202228">Veljkovic</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 30%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 46 por M.Nastasic" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/nikola-milenkovic/profil/spieler/413507">Milenkovic</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/nemanja-gudelj/profil/spieler/74294">Gudelj</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/sasa-lukic/profil/spieler/245056">Lukic</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 30%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 46 por L.Jovic" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/sergej-milinkovi%C4%87-savi%C4%87/profil/spieler/266302">Milinkovic.</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/filip-kostic/profil/spieler/161011">Kostic</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/dusan-tadic/profil/spieler/36139">Tadic</a>
						</span>
					</div>
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/andrija-zivkovic/profil/spieler/206843">Zivkovic</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 30%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 46 por Radonjic" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 3%; left: 40%;">
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/aleksandar-mitrovic/profil/spieler/51152">Mitrovic</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 30%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 62 por Grujic" rel="tooltip">&nbsp;</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div
			...
			<table class="ersatzbank">
				<tr>
					...
					<td><a title="Marko Dmitrovic"/marko-dmitrovic/profil/spieler/94308">Marko
							Dmitrovic</a></td>
					<td>POR</td>
				</tr>
				<tr>
					...
					<td><a title="Vanja Milinkovic-Savic"/vanja-milinkovi%C4%87-savi%C4%87/profil/spieler/257474">Vanja
							Milinkovic-Savic</a></td>
					<td>POR</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Stefan Mitrovic"/stefan-mitrovic/profil/spieler/143029">Stefan
							Mitrovic</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 73 por Pavlovic" rel="tooltip">&nbsp;</span>
					</td>
					<td>CEN</td>
				</tr>
				<tr>
					...
					<td><a title="Matija Nastasic"/matija-nastasic/profil/spieler/143559">Matija
							Nastasic</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 46 por M.Nastasic" rel="tooltip">&nbsp;</span>
					</td>
					<td>CEN</td>
				...
				<tr>
					...
					<td><a title="Aleksa Terzic"/aleksa-terzic/profil/spieler/404260">Aleksa
							Terzic</a></td>
					<td>LI</td>
				</tr>
				<tr>
					...
					<td><a title="Filip Mladenovic"/filip-mladenovic/profil/spieler/168063">Filip
							Mladenovic</a></td>
					<td>LI</td>
				</tr>
				<tr>
					...
					<td><a title="Marko Grujic"/marko-grujic/profil/spieler/222813">Marko
							Grujic</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 62 por Mitrovic" rel="tooltip">&nbsp;</span>
					</td>
					<td>PIV</td>
				</tr>
				<tr>
					...
					<td><a title="Uros Racic"/uros-racic/profil/spieler/417575">Uros
							Racic</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 79 L.Jovic" rel="tooltip">&nbsp;</span></td>
					<td>PIV</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Mihailo Ristic"/mihailo-ristic/profil/spieler/271455">Mihailo
							Ristic</a></td>
					<td>II</td>
				</tr>
				<tr>
					...
					<td><a title="Nemanja Radonjic"/nemanja-radonjic/profil/spieler/245078">Nemanja
							Radonjic</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 46 por A.Zivkovic" rel="tooltip">&nbsp;</span>
					</td>
					<td>EI</td>
				</tr>
				<tr>
					...
					<td><a title="Luka Jovic"/luka-jovic/profil/spieler/257462">Luka
							Jovic</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 46 por S.Lukic" rel="tooltip">&nbsp;</span>
					</td>
					<td>DEL</td>
				</tr>
				<tr style="background-color: #FBFBFB;">
					...
					<td><a title="Dragan Stojkovic" id="0"/dragan-stojkovic/profil/trainer/5528">Dragan
							Stojkovic</a></td>
					<td>&nbsp;</td>
				</tr>
			</table>
