...
<title>Selección suiza de Fútbol</title>
</head>
<body>
	...
	<br>
	<h1>
		Selección suiza de Fútbol <img src="imagenes/suiza.png" alt="suiza"
	...
	<div class="box viewport-tracking" data-viewport="Letzte_Formation">
		...
		<div class="formation_begegnung">
			...
			<div class="formation_ergebnis">
				<a title="Crónica" class="ergebnis-link" id="3732613"/spielbericht/index/spielbericht/3732613">1:1</a>
			</div>
			...
			<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							...
							title="Sustitución Min 63 por Frei" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/eray-comert/profil/spieler/298583">Cömert</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
				...
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 63 por Rodriguez" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 63 por Freuler" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
				...
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 75 por Steffen" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 81 por Okafor" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 3%; left: 40%;">
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 63 por Embolo" rel="tooltip">&nbsp;</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div
			...
			<table class="ersatzbank">
				...
				<tr>
					...
					<td><a title="Ricardo Rodríguez"/ricardo-rodriguez/profil/spieler/86784">Ricardo
							Rodríguez</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 63 por Mbabu" rel="tooltip">&nbsp;</span></td>
					<td>CEN</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Fabian Frei"/fabian-frei/profil/spieler/52595">Fabian
						...
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 63 por Elvedi" rel="tooltip">&nbsp;</span>
					</td>
					<td>PIV</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><a title="Remo Freuler"/remo-freuler/profil/spieler/148252">Remo
						...
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 63 por Xhaka" rel="tooltip">&nbsp;</span></td>
					<td>MC</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Rubén Vargas"/ruben-vargas/profil/spieler/345886">Rubén
							Vargas</a></td>
					<td>EI</td>
				</tr>
				<tr>
					...
					<td><a title="Renato Steffen"/renato-steffen/profil/spieler/194638">Renato
						...
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 75 por shaqiri" rel="tooltip">&nbsp;</span>
					</td>
					<td>EI</td>
				</tr>
				<tr>
					...
					<td><a title="Breel Embolo"/breel-embolo/profil/spieler/237662">Breel
						...
						title="Sustitución Min 63 por Gavranovic" rel="tooltip">&nbsp;</span>
					</td>
					<td>DEL</td>
				</tr>
				<tr>
