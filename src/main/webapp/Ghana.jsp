...
<title>Selección de Fútbol Ghanese</title>
</head>
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown "><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item text-danger" href="#">Ghana</a></li>
							<li><a class="dropdown-item text-dark"
	...
	<br>
	<h1>
		Selección de Fútbol Ghanese <img src="imagenes/Ghana.PNG" alt="Ghana"
	...
	<table class="alee">
		...
		<tbody>
			<%
					LinkedList<Jugadores> lista2 = Controller.getGhana();
	...
	<div class="keys" style="display: none"
		title="/ghana/startseite/verein/3441">
		<span>254285</span><span>274756</span><span>511168</span><span>418144</span><span>250844</span><span>214056</span><span>358250</span><span>451801</span><span>397171</span><span>579624</span><span>579062</span><span>188256</span><span>59641</span><span>230784</span><span>395695</span><span>543499</span><span>442805</span><span>272587</span><span>864121</span><span>534435</span><span>289182</span><span>548650</span><span>358985</span><span>108354</span><span>872380</span><span>154819</span>
	</div>
	</div>
	</div>
	...
	<div class="box viewport-tracking" data-viewport="Letzte_Formation">
		...
		<div class="formation_begegnung">
			<div class="formation_verein text-right">
				<a title="Nigeria"/nigeria/startseite/verein/3444/saison_id/2019">Nigeria</a>
				<a title="Nigeria"/nigeria/startseite/verein/3444/saison_id/2019"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/124.png?lm=1520611569"
					title="Nigeria" alt="Nigeria" class="flaggenrahmen" /></a>
			</div>
			<div class="formation_ergebnis">
				<a title="Crónica" class="ergebnis-link" id="3736288"/spielbericht/index/spielbericht/3736288">1:1</a>
			</div>
			<div class="formation_verein text-left">
				<a title="Ghana"/ghana/startseite/verein/3441/saison_id/2019"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/54.png?lm=1520611569"
					title="Ghana" alt="Ghana" class="flaggenrahmen" /></a> <a
					title="Ghana"/ghana/startseite/verein/3441/saison_id/2019">Ghana</a>
			</div>
			<div class="clearer"></div>
		</div>
			...
			<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/joe-wollacott/profil/spieler/418144">Wollacott</a>
						</span>
					</div>
					<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/daniel-amartey/profil/spieler/214056">Amartey</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; left: 36%; bottom: 73%;">
						<span class="icons_sprite icon-gelbekarte-formation" span
							title="Tarjeta Amarilla Min 26" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/alexander-djiku/profil/spieler/250844">Djiku</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/gideon-mensah/profil/spieler/397171">Mensah</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/denis-odoi/profil/spieler/59641">Odoi</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/thomas-partey/profil/spieler/230784">Partey</a>
						</span>
					</div>
					...
					<div
						...
						<span class="icons_sprite icon-tor-formation" span
							title="GOL Min 10" rel="tooltip">&nbsp;</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; left: 36%; bottom: 73%;">
						<span class="icons_sprite icon-gelbekarte-formation"
							data-type="link" span title="Tarjeta Amarilla Min 84"
							rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/iddrisu-baba/profil/spieler/442805">Baba</a>
						</span>
					</div>
					<div
						...
						<span style="cursor: pointer !important;"
							...
							title="Sustitución Min 46 por Yiadom" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/mohammed-kudus/profil/spieler/543499">Kudus</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 73 por Bukari" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/issahaku-fatawu/profil/spieler/864121">Fatawu</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 46 por Kyereh" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 3%; left: 40%;">
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/felix-afena-gyan/profil/spieler/872380">Afena-Gyan</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; left: 35%; bottom: 65%;">
						<span class="icons_sprite icon-gelbekarte-formation" span
							title="Tarjeta Amarilla Min 84" rel="tooltip">&nbsp;</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 90 por Wriedt K. O." rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a/jordan-ayew/profil/spieler/108354">Ayew</a>
						</span>
					</div>
					<div
						style="cursor: pointer; position: absolute; top: -5px; left: 36%;">
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 46 por Owusu" rel="tooltip">&nbsp;</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div
			...
			<table class="ersatzbank">
				<tr>
					...
					<td><a title="Richard Ofori"/richard-ofori/profil/spieler/274756">Richard
							Ofori</a></td>
					<td>POR</td>
				</tr>
				<tr>
					...
					<td><a title="Lawrence Ati Zigi"/lawrence-ati-zigi/profil/spieler/254285">Lawrence
							Ati Zigi</a></td>
					<td>POR</td>
				</tr>
				<tr>
					...
					<td><a title="Joseph Aidoo"/joseph-aidoo/profil/spieler/358250">Joseph
							Aidoo</a></td>
					<td>CEN</td>
				</tr>
				<tr>
					...
					<td><a title="Montari Kamaheni"/montari-kamaheni/profil/spieler/579624">Montari
							Kamaheni</a></td>
					<td>LI</td>
				</tr>
				<tr>
					...
					<td><a title="Andy Yiadom"/andy-yiadom/profil/spieler/188256">Andy
							Yiadom</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 46 por Baba" rel="tooltip">&nbsp;</span></td>
					<td>LD</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Elisha Owusu"/elisha-owusu/profil/spieler/395695">Elisha
							Owusu</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 46 por Ayew" rel="tooltip">&nbsp;</span></td>
					<td>PIV</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Daniel-Kofi Kyereh"/daniel-kofi-kyereh/profil/spieler/272587">Daniel-Kofi
							Kyereh</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 46 Fatawu" rel="tooltip">&nbsp;</span></td>
					<td>MCO</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Christopher Antwi-Adjei"/christopher-antwi-adjei/profil/spieler/289182">Christopher
							Antwi-Adjei</a></td>
					<td>EI</td>
				</tr>
				<tr>
					...
					<td><a title="Joseph Paintsil"/joseph-paintsil/profil/spieler/534435">Joseph
							Paintsil</a></td>
					<td>EI</td>
				</tr>
				<tr>
					...
					<td><a title="Osman Bukari"/osman-bukari/profil/spieler/548650">Osman
							Bukari</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 73 por Kudus" rel="tooltip">&nbsp;</span></td>
					<td>ED</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Yaw Yeboah"/yaw-yeboah/profil/spieler/358985">Yaw
							Yeboah</a></td>
					<td>ED</td>
				</tr>
				<tr>
					...
					<td><a title="Kwasi Wriedt"/kwasi-wriedt/profil/spieler/154819">Kwasi
							Wriedt</a> <span style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 90 por Afena-Gyan" rel="tooltip">&nbsp;</span>
					</td>
					<td>DEL</td>
				</tr>
				<tr style="background-color: #FBFBFB;">
					...
					<td><a title="Otto Addo" id="0"/otto-addo/profil/trainer/9029">Otto
							Addo</a></td>
					<td>&nbsp;</td>
				</tr>
			</table>
