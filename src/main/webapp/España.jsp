...
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown "><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item text-danger" href="#">España</a></li>
							<li><a class="dropdown-item text-dark"
	...
	<br>
	<h1>
		Selección Española de Fútbol <img src="imagenes/españa.png"
			alt="españa" width="100" height="100">
	</h1>
	...
	<table class="alee">
		...
		<tbody>
			<%
					LinkedList<Jugadores> lista2 = Controller.getEspaña();
	...
	<div class="box viewport-tracking" data-viewport="Letzte_Formation">
		...
		<div class="formation_begegnung">
			<div class="formation_verein text-right">
				<a title="España">España</a> <a title="España"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/157.png?lm=1520611569"
					title="España" alt="España" class="flaggenrahmen" /></a>
			</div>
			<div class="formation_ergebnis">
				<a title="Crónica" class="ergebnis-link" id="3773014">5:0</a>
			</div>
			...
			<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a>Simón</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
				...
				<div class="aufstellung-spieler-container"
					...
					<div style="color: white; font-weight: bold; font-size: 10px;">
						<span class="aufstellung-rueckennummer-name"> <a>Guillamón</a>
						</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
		...
		<div
			...
			<table class="ersatzbank">
				...
				<tr>
					...
					<td><a title="Eric García">Eric García</a></td>
					<td>CEN</td>
				</tr>
				<tr>
					<td class="nummer aufstellung-rueckennummer-ersatzbank">
					...
					<td><a title="Marcos Alonso">Marcos Alonso</a> <span
						...
						title="Sustitución Min 58 por J.Alba" rel="tooltip">&nbsp;</span>
					</td>
					<td>LI</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><a title="Gavi">Gavi</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 69 por C.Soler" rel="tooltip">&nbsp;</span>
					</td>
					<td>MC</td>
				</tr>
				<tr>
					...
					<td><a title="Pedri">Pedri</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 81 por C.Azpilicueta" rel="tooltip">&nbsp;</span>
					</td>
					<td>MC</td>
				</tr>
				<tr>
					...
					<td><a title="Ferran Torres">Ferran Torres</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 59 por D.Olmo" rel="tooltip">&nbsp;</span>
					</td>
					<td>EI</td>
				</tr>
				<tr>
					...
					<td><a title="Pablo Sarabia">Pablo Sarabia</a> <span
						style="cursor: pointer !important;"
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 58 por A.Morata" rel="tooltip">&nbsp;</span>
						<span style="cursor: pointer !important;"
