...
<title>Selección de Fútbol Iraní</title>
</head>
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown "><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item text-danger" href="#">Irán</a></li>
	...
	<br>
	<h1>
		Selección de Fútbol Iraní <img src="imagenes/iran.png" alt="iran"
	...
	<div class="box viewport-tracking" data-viewport="Letzte_Formation">
		...
		<div class="formation_begegnung">
			<div class="formation_verein text-right">
				<a title="Irán"/iran/startseite/verein/3582/saison_id/2019">Irán</a>
				<a title="Irán"/iran/startseite/verein/3582/saison_id/2019"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/71.png?lm=1520611569"
					title="Irán" alt="Irán" class="flaggenrahmen" /></a>
			</div>
			<div class="formation_ergebnis">
				<a title="Crónica" class="ergebnis-link" id="3625740"/spielbericht/index/spielbericht/3625740">2:0</a>
			</div>
			<div class="formation_verein text-left">
				<a title="Líbano"/libanon/startseite/verein/3586/saison_id/2019"><img
					src="https://tmssl.akamaized.net/images/flagge/verysmall/94.png?lm=1520611569"
					title="Líbano" alt="Líbano" class="flaggenrahmen" /></a> <a
					title="Líbano"/libanon/startseite/verein/3586/saison_id/2019">Líbano</a>
			</div>
			<div class="clearer"></div>
		</div>
			...
			<div
				...
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							...
							title="Sustitución Min 88 por Esmaeilifar" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 46 por Sarlak" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
				...
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 74 por Torabi" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 85 por Hosseinzadeh" rel="tooltip">&nbsp;</span>
					</div>
				</div>
				<div class="aufstellung-spieler-container"
					style="top: 3%; left: 40%;">
				...
				<div class="aufstellung-spieler-container"
					...
					<div
						...
						<span style="cursor: pointer !important;"
							class="icons_sprite icon-auswechslung-formation" span
							title="Sustitución Min 46 por Mehdipour" rel="tooltip">&nbsp;</span>
					</div>
				</div>
			</div>
		</div>
			...
			<table class="ersatzbank">
				...
				<tr>
					...
					<td><a title="Danial Esmaeilifar"/danial-esmaeilifar/profil/spieler/333603">Danial
						...
						title="Sustitución Min 88 por Moharrami" rel="tooltip">&nbsp;</span>
					</td>
					<td>LD</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><a title="Milad Sarlak"/milad-sarlak/profil/spieler/302898">Milad
						...
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 46 por Ezatolahi" rel="tooltip">&nbsp;</span>
					</td>
					<td>PIV</td>
				</tr>
				<tr>
					...
					<td><a title="Mehdi Mehdipour"/mehdi-mehdipour/profil/spieler/280033">Mehdi
						...
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 46 por Sayyadmanesh" rel="tooltip">&nbsp;</span>
					</td>
					<td>MC</td>
				</tr>
				<tr>
					...
					<td><a title="Amirhossein Hosseinzadeh"/amirhossein-hosseinzadeh/profil/spieler/542380">Amirhossein
						...
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 85 por Jahanbakhsh" rel="tooltip">&nbsp;</span>
					</td>
					<td>MCO</td>
				</tr>
				<tr>
					...
					<td><a title="Mehdi Torabi"/mehdi-torabi/profil/spieler/283833">Mehdi
						...
						class="icons_sprite icon-einwechslung-formation" span
						title="Sustitución Min 74 por Gholizadeh" rel="tooltip">&nbsp;</span>
					</td>
					<td>EI</td>
				</tr>
